...
public class Ironing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ironing_dashpage);
        ...
        myorders.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Ironing.this, OrderHead.class);
                tinydb.putString("serviceName","ironing");
...
//                Dashpage.this.finish();
    ...
    private void FindJobId2() {
        pd = new ProgressDialog(Ironing.this);
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Request request, IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        final Dialog openDialog = new Dialog(Ironing.this);
...
//                                                Intent intent = new Intent(Puckup.this,Ironing.class);
//                                                startActivity(intent);
                            }
                        });
                                ...
                                if (s.equalsIgnoreCase("0")){
                                    ...
                                    dialogCloseButton.setOnClickListener(new View.OnClickListener(){
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            openDialog.dismiss();
                                            Intent intent = new Intent(Ironing.this,SchedulePickup.class);
                                            tinydb.putString("serviceName","ironing");
                                            startActivity(intent);
                                        }
                                    });
                                    ...
                                    Intent intent = new Intent(Ironing.this, Pickup.class);
                                    tinydb.putDouble("expressDeliveryCharge",json.getDouble("expressDeliveryCharge"));
                                    tinydb.putString("serviceName","ironing");

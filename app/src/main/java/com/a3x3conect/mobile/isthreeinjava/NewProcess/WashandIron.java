...
public class WashandIron extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wash_press_dashpage);
        ...
        myorders.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(WashandIron.this, OrderHead.class);
                tinydb.putString("serviceName","washAndPress");
...
//                Dashpage.this.finish();
    ...
    private void FindJobId2() {
        pd = new ProgressDialog(WashandIron.this);
        ...
        try {
            ...
            postdat.put("serviceName", "washAndPress");
...
//                                                Intent intent = new Intent(Puckup.this,WashandIron.class);
//                                                startActivity(intent);
                            }
                        });
                                ...
                                if (s.equalsIgnoreCase("0")){
                                    ...
                                    dialogCloseButton.setOnClickListener(new View.OnClickListener(){
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            openDialog.dismiss();
                                            Intent intent = new Intent(WashandIron.this,SchedulePickup.class);
                                            tinydb.putString("serviceName","washAndPress");
                                            startActivity(intent);
                                        }
                                    });
                                    ...
                                    Intent intent = new Intent(WashandIron.this, Pickup.class);
                                    tinydb.putDouble("expressDeliveryCharge",json.getDouble("expressDeliveryCharge"));
                                    tinydb.putString("serviceName","washAndPress");
    ...
    private void FindJobId() {
        ...
        Log.e("request",postdat.toString());
        final Request request = new Request.Builder()
                .url(getString(R.string.baseurl)+"getJobStatus")
                .post(body)
                .build();
